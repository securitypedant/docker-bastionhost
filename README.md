...
docker buildx build --platform linux/amd64,linux/arm64 --build-arg USER=simon --build-arg USERPASS=notagoodpassword --push -t simonsecuritypedant/bastionhost:1.0 -t simonsecuritypedant/bastionhost:latest -f Dockerfile .
